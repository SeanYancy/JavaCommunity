...
//        return userMapper.selectById(id);
    ...
    public Map<String, Object> register(User user) throws IllegalAccessException {
        ...
        if (user == null) throw new IllegalAccessException("User Not null!");
        ...
        // localhost:49999/community/activation/101/code
        String url = domain + contextPath + "/activation/" + user.getId() + "/" + user.getActivationCode();
        context.setVariable("url", url);
        String content = templateEngine.process("/mail/activation", context);
        mailClient.sendMail(user.getEmail(),"牛客网激活邮件",content);
...
//        loginTicketMapper.insertLoginTicket(loginTicket);
        ...
        redisTemplate.opsForValue().set(redisKey, loginTicket); //会序列化为字符串
...
//        return userMapper.updateHeader(userId, headerUrl);
    ...
    public Collection<? extends GrantedAuthority> getAuthoritire(int userId) {
